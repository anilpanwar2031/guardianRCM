...
def AnnualMaximumBenefits(maximums):
    if len(maximums)!=0:
        ...
        for obj in maximums:
            if (obj['Type'] =='Calendar Individual Maximum' or obj['Type']=="Contract Individual Maximum" or obj['Type']=="Carryover Individual Maximum") and ("PPO" in obj['Network'] or "DPO" in obj['Network']) and "Restorative" in obj['ProgramMaximum_AppliesToTheFollowingServices_']:
                return  float(fixna(obj['Amount']).replace("$",""))
    else:
        return None    
...
# request=json.load(open(r"C:\Users\iamha\Desktop\BPK teck\All Payors\SDB EXTERNAL\ins\dev 20 july\SD%20Payor%20Scraping\ins.json", 'r'))
# data=json.load(open(r"C:\Users\iamha\Desktop\BPK teck\All Payors\SDB EXTERNAL\ins\dev 20 july\SD%20Payor%20Scraping\output.json", 'r'))
# browserr =""
